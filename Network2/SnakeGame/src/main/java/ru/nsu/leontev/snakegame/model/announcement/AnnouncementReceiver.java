package ru.nsu.leontev.snakegame.model.announcement;
...
public class AnnouncementReceiver implements Runnable {
    ...
    private void addNewGame(IpAddress ipAddress, SnakesProto.GameMessage.AnnouncementMsg gameAnnouncementMessage) {
